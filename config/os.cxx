...
template<> const char* SharedThread<Priority::Low>::kThread = "low";
template<> const int SharedThread<Priority::Low>::kThreadStack = 2048;
template<> const int SharedThread<Priority::Low>::kThreadTick = 10;
}
