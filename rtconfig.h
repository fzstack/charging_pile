...
#define TEST_COMPONENTS_FAL
#define TEST_COMPONENTS_LOWER_CONF
#define TEST_COMPONENTS_LOWER_BACKUP

/* Devices */

#define TEST_DEVICES_RELAY
#define TEST_DEVICES_SPI_HLW8112
